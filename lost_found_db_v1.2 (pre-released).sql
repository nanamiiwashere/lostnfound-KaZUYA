...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2026 at 05:29 PM
...
--
ALTER TABLE `pencocokan`
  MODIFY `id_pencocokan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `serah_terima`
--
ALTER TABLE `serah_terima`
  MODIFY `id_serah_terima` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
